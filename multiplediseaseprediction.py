# -*- coding: utf-8 -*-
"""
Created on Mon Sep  2 18:20:28 2024
...
parkinsons_model = pickle.load(open("trained_parkinsons_model.sav", 'rb'))
...
with st.sidebar:
    selected = option_menu('Multiple Disease Prediction System',
                         ...
                         # get symbols from bootsrap icons copy nme and paste it! 
...
if (selected == 'Diabetes Prediction'):
    ...
    with col1:
        SkinThickness = st.text_input('Enter the value of Skin Thickness: ')
    with col2:
    ...
    # Creatinng a button for prediction
